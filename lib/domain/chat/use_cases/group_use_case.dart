...
class CreateGroupUseCase{
  ...
  /*Future<Channel> createGroup(CreateGroupInput input)async{
    ...
    final imageResult = await _uploadStorageRepository.uploadPhoto(input.imageFile, "channels");
    final channel = await _streamApiRepository.createGroupChat(channelId, input.name, input.members, imageResult);
    return channel;
  }*/
}
